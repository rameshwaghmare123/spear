...
def get_model_config_conv(image_height, image_width):
    ...
    conv_num_channels_per_conv_layer = 8 # was 32
    conv_activation = "relu"
    conv_num_pool_layers = 2
    conv_num_channels_final_conv_layer = 64 # was 512
