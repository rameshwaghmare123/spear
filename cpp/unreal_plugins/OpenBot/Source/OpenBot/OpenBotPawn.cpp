...
AOpenBotPawn::AOpenBotPawn(const FObjectInitializer& object_initializer) : APawn(object_initializer)
{
    ...
    vehicle_movement_component_ = CreateDefaultSubobject<UOpenBotComponent>(TEXT("AOpenBotPawn::vehicle_movement_component_"));
    ...
    // Setup camera
    FVector camera_location(Config::get<float>("OPENBOT.OPENBOT_PAWN.CAMERA_COMPONENT.POSITION_X"),
    ...
    FRotator camera_orientation(Config::get<float>("OPENBOT.OPENBOT_PAWN.CAMERA_COMPONENT.PITCH"),
    ...
    // Setup IMU sensor
    FVector imu_location(Config::get<float>("OPENBOT.OPENBOT_PAWN.IMU_COMPONENT.POSITION_X"),
    ...
    FRotator imu_orientation(Config::get<float>("OPENBOT.OPENBOT_PAWN.IMU_COMPONENT.PITCH"), Config::get<float>("OPENBOT.OPENBOT_PAWN.IMU_COMPONENT.YAW"),
    ...
    // Setup Sonar sensor
    FVector sonar_location(Config::get<float>("OPENBOT.OPENBOT_PAWN.SONAR_COMPONENT.POSITION_X"),
    ...
    FRotator sonar_orientation(Config::get<float>("OPENBOT.OPENBOT_PAWN.SONAR_COMPONENT.PITCH"),
...
Eigen::Vector4f AOpenBotPawn::getWheelRotationSpeeds() const
{
    ...
    // wheel_rotation_speeds(0) = vehicle_movement_component_->VehicleSimulationPT->PVehicle->GetWheel(0).GetAngularVelocity(); // Expressed in [RPM]
    // wheel_rotation_speeds(1) = vehicle_movement_component_->VehicleSimulationPT->PVehicle->GetWheel(1).GetAngularVelocity(); // Expressed in [RPM]
    // wheel_rotation_speeds(2) = vehicle_movement_component_->VehicleSimulationPT->PVehicle->GetWheel(2).GetAngularVelocity(); // Expressed in [RPM]
    // wheel_rotation_speeds(3) = vehicle_movement_component_->VehicleSimulationPT->PVehicle->GetWheel(3).GetAngularVelocity(); // Expressed in [RPM]
    return rpmToRadSec(vehicle_movement_component_->getWheelRotationSpeeds()); // Expressed in [rad/s]
}
